                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="basic-login-inner inline-basic-form">
                                                    <?= form_open(base_url('admin/alternatif/hasil_wp')); ?>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="basic-login-inner inline-basic-form">
                                                    <div class="form-group-inner">
                                                        <div class="login-btn-inner">
                                                            <a href="<?= base_url() ?>admin/alternatif/cetak?kd_material=<?= $material ?>" type="button" target="_blank" class="btn btn-custon-four btn-primary"><i class="fa fa-print"></i> Cetak</a>
                                        ...
                                        <table class="table">
                                            ...
                                            <?php $no=1; foreach ($data_wp as $row) { ?>
                                                <tr>
                                                    ...
                                                    <td align="center"><?= $row['vektor_s']; ?></td>
