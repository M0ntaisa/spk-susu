...
<section class="home-slider owl-carousel">
    <div class="slider-item" style="background-image: url('<?= base_url() ?>assets/templates/home/images/hero_6.jpg');">
        <div class="container">
    ...
    <div class="slider-item" style="background-image: url('<?= base_url() ?>assets/templates/home/images/hero_1.jpg');">
        <div class="container">
        <div class="row slider-text align-items-center justify-content-center">
            <div class="col-lg-7 text-center col-sm-12 element-animate">
...
<section class="section">
    ...
    <div class="row align-items-stretch">
        ...
        <div class="h-100"><div class="frame h-100"><div class="feature-img-bg h-100" style="background-image: url('<?= base_url() ?>assets/templates/home/images/about_1.jpg');"></div></div></div>
        </div>
...
<section class="section element-animate">
    ...
    <div class="row align-items-center mb-5">
        ...
        <div class=""><div class="frame"><img src="<?= base_url() ?>assets/templates/home/images/about_2.jpg" alt="Image" class="img-fluid"></div></div>
        </div>
