...
<div class="slider-item" style="background-image: url('<?= base_url() ?>assets/templates/home/images/hero_7.jpg');">
...
<section class="section">
    ...
    <div class="row">
        ...
        <div class="media d-block media-custom text-center">
            <a href="#"><img src="<?= base_url() ?>assets/templates/home/images/person_1.jpg" alt="Image Placeholder" class="img-fluid"></a>
            <div class="media-body">
        ...
        <div class="col-lg-3">
        <div class="media d-block media-custom text-center">
            <a href="#"><img src="<?= base_url() ?>assets/templates/home/images/person_2.jpg" alt="Image Placeholder" class="img-fluid"></a>
            <div class="media-body">
        ...
        <div class="col-lg-3">
        <div class="media d-block media-custom text-center">
            <a href="#"><img src="<?= base_url() ?>assets/templates/home/images/person_4.jpg" alt="Image Placeholder" class="img-fluid"></a>
            <div class="media-body">
        ...
        <div class="col-lg-3">
        <div class="media d-block media-custom text-center">
            <a href="#"><img src="<?= base_url() ?>assets/templates/home/images/person_3.jpg" alt="Image Placeholder" class="img-fluid"></a>
            <div class="media-body">
